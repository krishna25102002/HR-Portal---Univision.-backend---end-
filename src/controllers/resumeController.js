...
export const uploadResume = async (req, res) => {
  try {
    ...
    // const parsed = await parseResume(fileBuffer);
    // For testing, we can skip actual parsing and use dummy data
  ...
  req.file.mimetype
    ...
    res.json({
      message: "Resume uploaded, parsed & stored successfully",
      resumeUrl,
      parsed,
    });
